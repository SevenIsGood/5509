...
#define LED_7seg (*((unsigned int *)0x600400))
	...
	temp_key=keyboard;
	  ...
	  { 
         ...
         if(temp_key == temp_key1)
		{
		  ...
		  {
			case 0x0fb:
				LED_7seg=0x0ff-uLED[1];
				key_val=1;
				break;
			case 0x0f7:
				LED_7seg=0x0ff-uLED[2];
				key_val=2;
				break;
			case 0x0ef:
				LED_7seg=0x0ff-uLED[3];
			key_val=3;
				break;
			case 0x0df:
				LED_7seg=0x0ff-uLED[4];
				key_val=4;
				break;
			case 0x0bf:
				LED_7seg=0x0ff-uLED[5];
				key_val=5;
				break;
			case 0x07f:
				LED_7seg=0x0ff-uLED[6];
				key_val=6;
				break;
			case 0x0fd:
				LED_7seg=0x0ff-uLED[7];
				key_val=7;
				break;
			case 0x0fe:
				LED_7seg=0x0ff-uLED[8];
				key_val=8;
				break;
			default:break;
		  }
