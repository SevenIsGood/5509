...
unsigned int Rx_Data[256],index;
...
void main(void)
{
 ...
 P7SEL |= BIT7;          
  ...
  P3OUT &= (~0x08);    //make cs low
  
  
 
  UCB0CTL1 |= UCSWRST;                      // **Put state machine in reset**
  UCB0CTL0 |= UCMST+UCSYNC+UCCKPL+UCMSB ;    // 3-pin, 8-bit SPI master  UCMST+  
