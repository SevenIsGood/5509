...
/*    SARAM_3 (RW) : origin = 0032000h length = 007000h*/ /* on-chip SARAM 17-20 */
	...
	SARAM   (RW) : origin = 0010000h length = 03A000h /* on-chip SARAM  */
	SARAM_29   (RW) : origin = 004A000h length = 002000h /* on-chip SARAM  */
	SARAM_30   (RW) : origin = 004C000h length = 002000h /* on-chip SARAM  */
	SARAM_31   (RW) : origin = 004E000h length = 002000h /* on-chip SARAM  */
...
SECTIONS
{
    ...
    .text       : > SARAM  ALIGN = 4
    .stack      : > SARAM_29  ALIGN = 4
    .sysstack   : > SARAM_29  ALIGN = 4
    .data       : > SARAM
    .bss        : > SARAM, fill = 0
	.cinit 		: > DARAM
	.const 		: > DARAM
