 ...
 *  Modifications to operate on 16-Bit Plattforms. Add functions.
...
#include "grammar_data.h" // FL: remove file I/O
...
#else
TIESRENGINECOREAPI_API unsigned short load_n_mfcc( short *n_mfcc_data );
#endif
...
TIESRENGINECOREAPI_API TIesrEngineStatusType load_mean_vec(char * mod_dir, gmhmm_type * gv ,
				    Boolean bLoadBaseMu );
#else
TIESRENGINECOREAPI_API TIesrEngineStatusType load_mean_vec(gmhmm_type * gv ,
				    Boolean bLoadBaseMu );
#endif
#endif
...
// Michael Schuster / Enertex Bayern GmbH
// You have to implement these functions for your system
#ifndef NO_FILE_IO // FL: remove file I/O
...
#else
TIesrEngineStatusType load_word_list( short *word_list, gmhmm_type *gv );
