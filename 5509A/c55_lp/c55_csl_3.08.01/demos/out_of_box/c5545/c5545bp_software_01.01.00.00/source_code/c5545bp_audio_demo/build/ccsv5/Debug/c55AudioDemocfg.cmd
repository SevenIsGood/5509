...
_SWI_AudioDataProcess = SWI_AudioDataProcess;
_SWI_AudioMicDataCollection = SWI_AudioMicDataCollection;
_SWI_LcdDisplay = SWI_LcdDisplay;
_SWI_Recognizer = SWI_Recognizer;
_SWI_SysInit = SWI_SysInit;
_SWI_SysState = SWI_SysState;
_SWI_UserInput = SWI_UserInput;
_SWI_readAudioData = SWI_readAudioData;
_SWI_readSPIData = SWI_readSPIData;
_SWI_sendSPIData = SWI_sendSPIData;
_SWI_updateBleFW = SWI_updateBleFW;
_SWI_updateDisplay = SWI_updateDisplay;
_TSK_idle = TSK_idle;
_IDL_userIdle = IDL_userIdle;
_LOG_system = LOG_system;
_SEM_mmcDone = SEM_mmcDone;
